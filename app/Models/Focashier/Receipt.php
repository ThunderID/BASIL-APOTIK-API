...
class Receipt extends Model
{
	...
	// CONFIGURATIONS
	// --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	CONST TYPE 		= ['OFFICIAL_RECEIPT', 'DEPOSIT_VOUCHER', 'BREAKFAST_VOUCHER'];
	...
	public function getRules()
	{
		...
		$rules['lines.*.qty']			= ['nullable', 'string'];
	...
	public function generateNo() {
		...
		$idx 		= Receipt::where('no', 'like', $prefix.'%')->count() + 1;
		do{
			$no 	= $prefix.'.'.str_pad($idx, 4, '0', STR_PAD_LEFT);
			$exists	= Receipt::where('no', $no)->first();
			$idx++;
		}while ($exists);
